...
for label in button_labels:
    if label == '=':
        ...
        tk.Button(parent, text=label,bg='darkred',activebackground='red', activeforeground='white', fg='white', padx=20, pady=20, font=("Arial", 16), command=clear_display).grid(row=row_val, column=col_val, columnspan=2, sticky='EW')
    else:
