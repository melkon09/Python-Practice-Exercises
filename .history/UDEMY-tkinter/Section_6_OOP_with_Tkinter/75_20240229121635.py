...
class FeetToMeters(ttk.Frame):
    def __init__(self, container, **kwargs):
        ...
        feet_label=ttk.Label(self, text="Meters:")
        feet_input=ttk.Entry(self, width=10, textvariable=self.meters_value, font=("Segoe UI", 12))
        meters_label=ttk.Label(self, text="Feet:")
        meters_display=ttk.Label(self, textvariable=self.feet_value)
        calc_button=ttk.Button(self, text="Calculate", command=self.calculate_feet)
