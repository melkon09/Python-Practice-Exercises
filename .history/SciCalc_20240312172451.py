...
display=tk.Entry(frame,font=('Helvetica',20,'bold'), bg='lightgreen', fg='black',textvariable=display_value, width=20, justify='right', bd=5)
...
def square_root():
    display_value = math.sqrt(float(display_value.get()))
    display.update()
